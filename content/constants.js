...
const MAIN_METHOD_REGEX = /\b(?=[a-zA-Z\s]*\bstatic\b)(?:public|protected|private|final|static|synchronized|native|strictfp|\s)+void\s+main\s*\(\s*(?:final\s+)?(?:String(?:\s*\[\s*\]|\s*\.\.\.)\s+[a-zA-Z_$가-힣ㄱ-ㅎㅏ-ㅣ][a-zA-Z0-9_$가-힣ㄱ-ㅎㅏ-ㅣ]*|String\s+[a-zA-Z_$가-힣ㄱ-ㅎㅏ-ㅣ][a-zA-Z0-9_$가-힣ㄱ-ㅎㅏ-ㅣ]*\s*\[\s*\])\s*\)/m;
